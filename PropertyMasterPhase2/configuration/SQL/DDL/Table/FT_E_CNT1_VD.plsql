...
, l_tbl_name);
			...
			execute format('CREATE UNIQUE INDEX FT_E_CNT1_U001 ON FT_E_CNT1 (INSTR_ID,WSO_CNTRCT_ID,START_TMS,DATA_SRC_ID)',l_tbl_name);
...
raise notice 'l_tbl_exists_flag: %', l_tbl_exists_flag;
raise notice 'l_view_exists_flag: %', l_view_exists_flag;
